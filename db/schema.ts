...
export const characterHpLog = pgTable('character_hp_log', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
...
export const characterDrItems = pgTable('character_dr_items', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
...
export const characterAbilityMods = pgTable('character_ability_mods', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
...
export const characterAbilityLog = pgTable('character_ability_log', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
  abilityKey: text('ability_key').notNull(),
  type: text('type').notNull(),
...
export const characterAcVariedMods = pgTable('character_ac_varied_mods', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
  label: text('label').notNull(),
  value: integer('value').notNull().default(0),
...
export const characterInitVariedMods = pgTable('character_init_varied_mods', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
  label: text('label').notNull(),
  value: integer('value').notNull().default(0),
...
export const characterSpellbooks = pgTable('character_spellbooks', {
  id: uuid('id').primaryKey().defaultRandom(),
  characterId: characterId(),
...
export const characterSpellCircles = pgTable('character_spell_circles', {
  id: uuid('id').primaryKey().defaultRandom(),
...
export const characterSkillMods = pgTable('character_skill_mods', {
  id: uuid('id').primaryKey(),
...
export const characterConditionalMods = pgTable('character_conditional_mods', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
...
export const characterWeaponAmmoLog = pgTable('character_weapon_ammo_log', {
  id: uuid('id').primaryKey(),
...
export const characterArmorItems = pgTable('character_armor_items', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
  name: text('name').notNull(),
 ...
 */
export const characterSnapshots = pgTable('character_snapshots', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
...
export const characterSessionLog = pgTable('character_session_log', {
  id: uuid('id').primaryKey(),
  characterId: characterId(),
  title: text('title').notNull(),
  date: text('date').notNull(),
