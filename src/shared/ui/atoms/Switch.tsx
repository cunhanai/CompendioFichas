...
const trackVariants = cva(
  'inline-flex shrink-0 items-center rounded-full p-0.5 transition appearance-none',
  {
    variants: {
      tone: {
...
const thumbVariants = cva('block rounded-full bg-white transition', {
  variants: {
    size: {
      sm: 'h-3 w-3 data-[checked]:translate-x-3 data-[unchecked]:translate-x-0',
      md: 'h-4 w-4 data-[checked]:translate-x-4 data-[unchecked]:translate-x-0',
    },
  },
